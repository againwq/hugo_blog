...
![5G频段介绍](/images/5G物理信道与信号/5G频域资源概述.PNG)
...
![5G传输带宽](/images/5G物理信道与信号/5G传输带宽.PNG)

2. 最小保护带宽

![5G保护带宽](/images/5G物理信道与信号/5G最小保护带宽.PNG)
...
![5G频段分配](/images/5G物理信道与信号/5G频段分配.PNG)
...
![RB](/images/5G物理信道与信号/RB.PNG)

PointA参考点

![alt text](/images/5G物理信道与信号/PointA参考点.PNG)
...
![SCS适应的场景](/images/5G物理信道与信号/不同SCS场景.PNG)
...
![时域帧结构](/images/5G物理信道与信号/时域帧结构.PNG)
...
![uRLLC场景帧结构](/images/5G物理信道与信号/uRLLC场景帧结构.PNG)
...
![5G下行物理信道与信号](/images/5G物理信道与信号/5G下行信道与信号.PNG)

### SSB

#### 基本概念

![SSB](/images/5G物理信道与信号/SSB概念.PNG)
...
![SSB的频域位置](/images/5G物理信道与信号/SSB频域位置.PNG)
...
![SSB时域位置](/images/5G物理信道与信号/SSB时域位置.PNG)
...
![SSB Case C](/images/5G物理信道与信号/SSB时域CaseC.PNG)

### PDCCH信道(下行控制信道, Polar编码, QPSK调制)

主要承载**DCI(Downlink Control Information, 下行控制信息).**

![PDCCH信道](/images/5G物理信道与信号/PDCCH信道.PNG)
...
![CORESET](/images/5G物理信道与信号/CORESET.PNG)
...
![PDCCH聚合等级](/images/5G物理信道与信号/PDCCH聚合等级.PNG)
...
![PDCCH盲检](/images/5G物理信道与信号/PDCCH盲检.PNG)
...
![搜索空间](/images/5G物理信道与信号/搜索空间.PNG)
...
![PDSCH时域资源](/images/5G物理信道与信号/PDSCH时域资源.PNG)
...
![PDSCH时域结构](/images/5G物理信道与信号/PDSCH时域结构.PNG)
...
![PDSCH频域](/images/5G物理信道与信号/PDSCH频域.PNG)
...
![PDSCH-DMRS频域Type1](/images/5G物理信道与信号/PDSCH-DMRS频域Type1.PNG)

+ Type2: 单符号**支持6用户**, 双符号**支持12用户**,使用**3个CDM组**, 每个端口上DMRS密度为**4子载波/PRB**(比type1小)

![PDSCH-DMRS频域Type2](/images/5G物理信道与信号/PDSCH-DMRS频域Type2.PNG)

### CSI-RS(信道状态信息参考信号)

在**3GPP 10版本**引入, 主要用于**获取下行信道状态**

![CSI-RS](/images/5G物理信道与信号/CSI-RS.PNG)
...
![CSI-RS上报](/images/5G物理信道与信号/CSI-RS.上报PNG.PNG)

#### CDM-Type(CSI-RS资源映射的码分复用)

不同类型可以复用**1, 2, 4, 8**个端口(用户)

![CDM-Type](/images/5G物理信道与信号/CDM-Type.PNG)
...
![长前导码](/images/5G物理信道与信号/PRACH-长前导码.PNG)
...
![短前导码](/images/5G物理信道与信号/PRACH-短格式前导码.PNG)
...
![PRACH频域](/images/5G物理信道与信号/PRACH频域资源.PNG)

**起点与长度的确定**

![前导码频域起点与长度](/images/5G物理信道与信号/前导码频域资源.PNG)
...
![PUSCH时域资源](/images/5G物理信道与信号/PUSCH时域分配.PNG)
